...
class VideoDetailsFormProvider {
    ...
    private function createTitleInput($value){
        if($value == null) $value = "";
        return "<div class='form-group'>
                    <input type='text' class='form-control' name='titleInput' placeholder='Title' value='$value'>
                </div>";
    }
    ...
    private function createDescriptionInput($value){
        if($value == null) $value = "";
        return "<div class='form-group'>
                    <textarea placeholder='Description' class='form-control' name='descriptionInput' rows='3'>$value 
                    </textarea>
                </div>";
    }
